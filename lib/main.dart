    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            children: [
              ...
              MarkerLayer(
                markers: misPlazas.map((plaza) {
                  // ⭐ Color del marcador según el MODO ACTUAL
                  final estadoActual =
                      plaza[_modoActual.campoEstado]
                          ?.toString()
                          .toLowerCase() ??
                      'sin evaluar';
          ...
          // ⭐ NUEVO: Indicador del modo actual (top-left)
          Positioned(
            top: 16,
            left: 16,
            child: Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text(_modoActual.icono, style: const TextStyle(fontSize: 20)),
                  const SizedBox(width: 8),
                  Text(
                    _modoActual.nombre,
                    style: const TextStyle(
