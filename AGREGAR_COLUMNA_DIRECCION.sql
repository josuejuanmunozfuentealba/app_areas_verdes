...
-- Fecha: 2026-09-10
-- Total: 77 plazas con direcciones
-- =============================================
...
-- Paso 2: Actualizar direcciones de TODAS las plazas (77 registros)
...
UPDATE plazas SET direccion = 'Bernardo O''Higgins con Psje. Javiera Carrera' WHERE id = '67';
